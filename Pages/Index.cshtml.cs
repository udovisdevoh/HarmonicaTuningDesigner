    ...
    public class IndexModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            if (ViewModel.Diatonic != null)
            {
                ...
                if (ViewModel.Diatonic.Holes == null || ViewModel.Diatonic.Holes.Count == 0 || rotatedPlateId == "Diatonic" || IsPlateSelectPosted("Diatonic"))
                {
            ...
            if (ViewModel.ChromaticUpper != null)
            {
                ...
                if (ViewModel.ChromaticUpper.Holes == null || ViewModel.ChromaticUpper.Holes.Count == 0 || rotatedPlateId == "ChromaticUpper" || IsPlateSelectPosted("ChromaticUpper"))
                {
            ...
            if (ViewModel.ChromaticLower != null)
            {
                ...
                if (ViewModel.ChromaticLower.Holes == null || ViewModel.ChromaticLower.Holes.Count == 0 || rotatedPlateId == "ChromaticLower" || IsPlateSelectPosted("ChromaticLower"))
                {
        ...
        {
            // The select inputs generated by the partial will post keys like "ViewModel.Diatonic.Tuning" etc.
            if (string.IsNullOrEmpty(plateId)) return false;
            var tuningKey = $"ViewModel.{plateId}.Tuning";
            var keyKey = $"ViewModel.{plateId}.Key";
            var modeKey = $"ViewModel.{plateId}.Mode";
            return Request.Form.ContainsKey(tuningKey) || Request.Form.ContainsKey(keyKey) || Request.Form.ContainsKey(modeKey);
        }
